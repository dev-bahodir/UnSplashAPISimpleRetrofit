...
import dev.bahodir.unsplashapiretrofit.databinding.FragmentFashionBinding
...
import dev.bahodir.unsplashapiretrofit.retrofit.Fashion
...
class FashionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        APIClient.getRetrofit().create(Fashion::class.java)
            .getFashion().enqueue(object : Callback<UnSplashAPIUser> {
