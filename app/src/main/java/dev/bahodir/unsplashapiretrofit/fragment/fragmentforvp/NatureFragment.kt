...
import dev.bahodir.unsplashapiretrofit.databinding.FragmentNatureBinding
...
import dev.bahodir.unsplashapiretrofit.retrofit.Nature
...
class NatureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        APIClient.getRetrofit().create(Nature::class.java)
            .getNature().enqueue(object : Callback<UnSplashAPIUser> {
