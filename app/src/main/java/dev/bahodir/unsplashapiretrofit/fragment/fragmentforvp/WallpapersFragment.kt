...
import dev.bahodir.unsplashapiretrofit.databinding.FragmentWallpapersBinding
 ...
 * Use the [WallpapersFragment.newInstance] factory method to
...
class WallpapersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        APIClient.getRetrofit().create(Wallpapers::class.java)
            .getWallpapers().enqueue(object : Callback<UnSplashAPIUser> {
