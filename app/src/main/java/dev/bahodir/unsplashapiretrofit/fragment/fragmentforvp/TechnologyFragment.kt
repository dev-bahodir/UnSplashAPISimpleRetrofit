...
import dev.bahodir.unsplashapiretrofit.databinding.FragmentTechnologyBinding
import dev.bahodir.unsplashapiretrofit.retrofit.APIClient
import dev.bahodir.unsplashapiretrofit.retrofit.Technology
...
class TechnologyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        APIClient.getRetrofit().create(Technology::class.java)
            .getTechnology().enqueue(object : Callback<UnSplashAPIUser> {
